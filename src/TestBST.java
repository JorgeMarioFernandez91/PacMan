...
public class TestBST {
	...
	public static void main(String[] args) {
		...
		Pixel pixels[] = new Pixel[6];
		Location points[] = new Location[6];
		int colors[] = {5, 3, 1, 2, 4,6};
		int x[] = {4,2,1,1,3,4};
		int y[] = {4,3,1,2,4,10};
		...
		try {
			...
			//tree.put(tree.getRoot(), pixels[5]);
		...
		/*
		try {
			tree.remove(tree.getRoot(),points[0]);  // Delete custom data
			System.out.println("Test 6.5 failed");
		}
		catch(InexistentKeyException e) {
			System.out.println("Test 6.5 passed");
		}
		catch (Exception e) {
			System.out.println("Test 6.5 failed");
		}
